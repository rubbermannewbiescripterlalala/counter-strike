...
new akdragon_V_MODEL[64] = "models/zm/v_akd1.mdl"
new akdragon_P_MODEL[64] = "models/zm/p_akd1.mdl"
new akdragon_W_MODEL[64] = "models/zm/w_akd1.mdl"
...
public plugin_init()
{
	...
	cvar_recoil_akdragon = register_cvar("zp_akdragon_recoil", "1.0")
	cvar_clip_akdragon = register_cvar("zp_akdragon_clip", "30")
	cvar_spd_akdragon = register_cvar("zp_akdragon_spd", "1.0")
	cvar_akdragon_ammo = register_cvar("zp_akdragon_ammo", "180")
	
	g_itemid_akdragon = zp_register_extra_item("[As. Rifle] AK47 Red Dragon", 12, ZP_TEAM_HUMAN)
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_ak47dragon.txt")
   	precache_generic("sprites/zm/640hud45.spr")
    	precache_generic("sprites/zm/640hud7.spr")
	
        register_clcmd("weapon_ak47dragon", "weapon_hook")	
...
public give_akdragon(id)
{
	...
	if( iWep2 > 0 )
	{
		...
		write_string("weapon_ak47dragon")
		write_byte(2)
		write_byte(90)
		write_byte(-1)
		write_byte(-1)
