...
new mg3_W_MODEL[64] = "models/zm/w_mg3.mdl"
...
public plugin_init()
{
	...
	cvar_dmg_mg3 = register_cvar("zp_mg3_dmg", "1.13")
	cvar_recoil_mg3 = register_cvar("zp_mg3_recoil", "1.04")
	cvar_clip_mg3 = register_cvar("zp_mg3_clip", "200")
	cvar_spd_mg3 = register_cvar("zp_mg3_spd", "0.93")
	cvar_mg3_ammo = register_cvar("zp_mg3_ammo", "200")
	
	g_itemid_mg3 = zp_register_extra_item("[Mashingun] MG3", 40, ZP_TEAM_HUMAN)
...
public plugin_precache()
{
	...
	precache_generic("sprites/weapon_mg3.txt")
   	precache_generic("sprites/zm/640hud28.spr")
    	precache_generic("sprites/zm/640hud7.spr")
	
        register_clcmd("weapon_mg3", "weapon_hook")	
